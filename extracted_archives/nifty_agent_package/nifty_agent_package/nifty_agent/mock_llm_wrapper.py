...
class MockNiftyLLM:
    """A mock wrapper for the Nifty LLM, returning predefined responses."""
    def __init__(self, responses: list):
        self.responses = responses
        self.call_count = 0
        logger.info("Mock Nifty LLM initialized with predefined responses.")
    ...
    def close(self):
        logger.info("Mock Nifty LLM closed.")
